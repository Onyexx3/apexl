      ...
      <Card>
        ...
        <CardContent>
          <Table>
            ...
            <TableBody>
              {(() => {
                const filteredStaff = currentUser?.role === "manager" 
                  ? branch.staff?.filter(s => s.role !== "admin") 
                  : branch.staff;
                  ...
                  return (
                    <TableRow>
                      <TableCell colSpan={6} className="text-center text-muted-foreground py-8">
                        No staff members in this branch. {currentUser?.role === "admin" && "Add your first staff member."}
                      </TableCell>
                    </TableRow>
                  );
                }
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    placeholder="Photo URL or upload an image"
                    className="flex-1"
                  />
                  <input
                    type="file"

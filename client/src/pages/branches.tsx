              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>The full name of this branch office</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Short code to identify this branch (max 10 characters)</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Physical address of the branch office</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Contact phone number for the branch</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Input
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Whether this branch is currently operational</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
                <Select
